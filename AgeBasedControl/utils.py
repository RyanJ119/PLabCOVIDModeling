...
def make_result_directory_for_simulation(state_id, beta, R0, percentage_essential, model = "", prefix=""):
    results_path = os.path.join("../results/", f"{model}_{prefix}{state_id}_beta{beta}_R0{R0}_PE{percentage_essential}")
    try:
